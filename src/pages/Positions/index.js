    ...
    return (
        <div className="page-content">
            ...
            <div className="container-fluid">
                <Breadcrumbs breadcrumbItem={`VƏZİFƏLƏR (${total})`}/>
                <Row>
                    <Col sm={12}>
                        <Card>
                            {isFetching ? (
